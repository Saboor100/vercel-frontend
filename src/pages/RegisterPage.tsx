...
const RegisterPage = () => {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          title: t("register.googleSuccessTitle"),
          description: t("register.googleSuccessDescription"),
        });
        navigate("/");
      } else {
        setError(result.error || t("register.googleFailed"));
      }
    } catch (err) {
      setError(
        err instanceof Error ? err.message : t("register.unexpectedError")
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-[#E67912] hover:bg-[#fca657] text-white border-[#E67912]"
              disabled={loading}
            >
          ...
          >
            ...
            {googleLoading ? t("register.signingUp") : t("register.googleBtn")}
          </Button>
        </CardContent>
